...
class ModelDetailsController extends Controller
{
	...
	{       
                $sc=new ServiceComponent($this,"ModelDetails",METADB_DB);
                $sc->showAll();
	...
	{
		$dataProvider=new CActiveDataProvider('ModelDetails');
	...
	{
		$model=new ModelDetails('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ModelDetails']))
			$model->attributes=$_GET['ModelDetails'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='model-details-form')
		{
