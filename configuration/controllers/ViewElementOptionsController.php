...
class ViewElementOptionsController extends Controller
{
	/**
	...
	{       
                $sc=new ServiceComponent($this,"ViewElementOptions", METADB_DB);
                $sc->showAll();
	...
	{
		$model=new ViewElementOptions;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['ViewElementOptions']))
		{
			$model->attributes=$_POST['ViewElementOptions'];
			if($model->save()){
	...
	{
		$dataProvider=new CActiveDataProvider('ViewElementOptions');
	...
	{
		$model=new ViewElementOptions('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ViewElementOptions']))
			$model->attributes=$_GET['ViewElementOptions'];
	...
	{
		$model=ViewElementOptions::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='view-element-options-form')
		{
