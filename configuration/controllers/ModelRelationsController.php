...
class ModelRelationsController extends Controller
{
	...
	{       
                $sc=new ServiceComponent($this,"ModelRelations",METADB_DB);
                $sc->showAll();
	...
	{
		$model=new ModelRelations;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['ModelRelations']))
		{
			$model->attributes=$_POST['ModelRelations'];
			if($model->save()){
	...
	{
		$dataProvider=new CActiveDataProvider('ModelRelations');
	...
	{
		$model=new ModelRelations('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ModelRelations']))
			$model->attributes=$_GET['ModelRelations'];
	...
	{
		$model=ModelRelations::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='model-relations-form')
		{
