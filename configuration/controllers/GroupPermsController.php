...
class GroupPermsController extends Controller
{
	...
	{       
                $sc=new ServiceComponent($this,"GroupPerms", METADB_DB);
                $sc->showAll();
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['GroupPerms']))
		{
			$model->attributes=$_POST['GroupPerms'];
			if($model->save()){
	...
	{
		$dataProvider=new CActiveDataProvider('GroupPerms');
	...
	{
		$model=new GroupPerms('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['GroupPerms']))
			$model->attributes=$_GET['GroupPerms'];
	...
	{
		$model=GroupPerms::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='group-perms-form')
		{
