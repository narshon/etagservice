...
class ModuleController extends Controller
{
	...
	{       
                $sc=new ServiceComponent($this,"Module", METADB_DB);
                $sc->showAll();
		...
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','audit'),
				'users'=>array('@'),
			),
        ...
        public function actionAudit()
	{
               ...
               $change_no=$_POST['change_no'];
               $comments=$_POST['comments'];
               
               Yii::app()->session->add('change_no',$change_no);
               Yii::app()->session->add('change_comments',$comments);
               
	       echo CJSON::encode(array(
                                    'status'=>'success', 
                                    'div'=>"successfully added, continue with the change "
                                    ));
               exit;    
	}
