...
class PortletsController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Portlets']))
		{
			$model->attributes=$_POST['Portlets'];
			if($model->save()){
	...
	{
		$dataProvider=new CActiveDataProvider('Portlets');
	...
	{
		$model=new Portlets('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Portlets']))
			$model->attributes=$_GET['Portlets'];
	...
	{
		$model=Portlets::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='portlets-form')
		{
