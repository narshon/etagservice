...
class ModelValidationsController extends Controller
{
	/**
	...
	{       
		...
		$model=new ModelValidations;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['ModelValidations']))
		{
			$model->attributes=$_POST['ModelValidations'];
			if($model->save()){
	...
	{
		$dataProvider=new CActiveDataProvider('ModelValidations');
	...
	{
		$model=new ModelValidations('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ModelValidations']))
			$model->attributes=$_GET['ModelValidations'];
	...
	{
		$model=ModelValidations::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='model-validations-form')
		{
