...
class SkipPatternsController extends Controller
{
	/**
	...
	{       
                $sc=new ServiceComponent($this,"SkipPatterns", METADB_DB);
                $sc->showAll();
	...
	{
		$model=new SkipPatterns;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['SkipPatterns']))
		{
			$model->attributes=$_POST['SkipPatterns'];
			if($model->save()){
	...
	{
		$dataProvider=new CActiveDataProvider('SkipPatterns');
	...
	{
		$model=new SkipPatterns('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['SkipPatterns']))
			$model->attributes=$_GET['SkipPatterns'];
	...
	{
		$model=SkipPatterns::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='skip-patterns-form')
		{
