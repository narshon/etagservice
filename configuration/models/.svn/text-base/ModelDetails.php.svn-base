...
/**
 * This is the model class for table "meta_model_details".
 *
 * The followings are the available columns in table 'meta_model_details':
 * @property integer $id
 ...
 */
class ModelDetails extends MetaActiveRecord
{
...
private $datahelper;
         ...
         */
         public function __construct($scenario = 'insert',$dh=false){
               if(CONFIG_MODE == 1)
                $this->datahelper = new DataHelper('ModelDetails','meta_model_details');
	...
	public function search($filters=array())
	{
        ...
        public function getChangeNumber($pk){
            return 1;
        }
        public function getChangeReason($pk){
            return "bluh bluh bluh";
        }
