...
/**
 * This is the model class for table "meta_permissions".
 *
 * The followings are the available columns in table 'meta_permissions':
 * @property integer $id
 ...
 */
class Permissions extends MetaActiveRecord
{
...
private $datahelper;
         ...
         */
         public function __construct($scenario = 'insert',$dh=true){
               if($dh)
                $this->datahelper = new DataHelper('Permissions','meta_permissions');
