...
/**
 * This is the model class for table "meta_groups".
 *
 * The followings are the available columns in table 'meta_groups':
 * @property integer $id
 ...
 */
class Groups extends MetaActiveRecord
{
...
private $datahelper;
         ...
         */
         public function __construct($scenario = 'insert',$dh=true){
               if($dh)
                $this->datahelper = new DataHelper('Groups','meta_groups');
