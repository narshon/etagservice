...
class adLDAP {
    ...
    * @var string
    */   
	protected $accountSuffix = "@kwtrp.org";
    ...
    * @var string
    */
	protected $baseDn = "OU=Groups,OU=Users,OU=KEMRI-WTRP,DC=kwtrp,DC=org"; 
    ...
    * @var array
    */
    protected $domainControllers = array("172.16.12.84");
    ...
    * @var string
    */
    protected $adminUsername = "ldapuser";
    protected $adminPassword = 'pa$$w0rd';
    ...
    */
    public function connect() 
    {
        ...
        if ($this->adminUsername !== NULL && $this->adminPassword !== NULL) {
            $this->ldapBind = @ldap_bind($this->ldapConnection, $this->adminUsername . "@kwtrp.org", $this->adminPassword);
            if (!$this->ldapBind) {
    ...
    */
    public function authenticate($username, $password, $preventRebind = false) {
        ...
        $this->ldapBind = @ldap_bind($this->ldapConnection, $username . "@kwtrp.org", $password);
		//print $this->ldapBind ; exit;
        if (!$this->ldapBind){		
            return false;
        }
		...
		//echo "here ", $this->getLastError(), exit;
